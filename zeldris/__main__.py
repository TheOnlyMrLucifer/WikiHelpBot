# WikiLeaksGroupBotRobot
# Copyright (C) 2017-2019, Paul Larsen
# Copyright (C) 2022, IDNCoderX Team, <https://github.com/IDN-C-X/WikiLeaksGroupBotRobot>
#
...
from WikiLeaksGroupBot.modules import ALL_MODULES
from WikiLeaksGroupBot.modules.disable import DisableAbleCommandHandler
from WikiLeaksGroupBot.modules.helper_funcs.chat_status import is_user_admin
from WikiLeaksGroupBot.modules.helper_funcs.misc import paginate_modules
from WikiLeaksGroupBot.modules.purge import client
from WikiLeaksGroupBot.modules.sql import users_sql as sql
...
WikiLeaksGroupBot_IMG = "https://telegra.ph/file/b9b3e76c4b930a6ec223e.jpg"

PM_START_TEXT = """
Hey there! my name is *{}*. 
A group management bot with useful features. [ㅤ](https://telegra.ph/file/b9b3e76c4b930a6ec223e.jpg)

Made By WikiLeaks @TheOnlyMrLucifer

◑ *Uptime:* `{}`
◑ `{}` *Users, across* `{}` *chats.*

Need Any Of My Other Bots
Join My Bots Lounge [WikiLeaks Bot Lounge](https://t.me/WikiLeaksBots).
...
buttons = [
    [
        ...
        InlineKeyboardButton(
            text="Bots Lounge 📢",
            url="https://t.me/WikiLeaksBots",
        ),
    ],
    [
        InlineKeyboardButton(
            text="Add WikiLeaksGroupBot to Your Group 👥",
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("WikiLeaksGroupBot.modules." + module_name)
...
def main():
    ...
    if WEBHOOK:
        LOGGER.info("[WikiLeaksGroupBot] Using webhooks.")
        ...
        LOGGER.info("[WikiLeaksGroupBot] Using long polling.")
...
if __name__ == "__main__":
    LOGGER.info("[WikiLeaksGroupBot] Successfully loaded modules: " + str(ALL_MODULES))
