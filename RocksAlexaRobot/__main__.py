...
"""
PMSTART_CHAT = (
    "[ Welcome User!!!](https://te.legra.ph/file/ab804c327ee6b0f52299a.jpg)",
    "[I'm A WikiLeaks Project](https://te.legra.ph/file/ab804c327ee6b0f52299a.jpg)",
    "[I Shall Help You WIth Your Problems 🔥](https://telegra.ph/file/35e730dea457c85cc367b.mp4)",
    "[I'm WikiGroup BOT!!!!](https://te.legra.ph/file/e6d0760dbb3bde20fd16b.jpg)", )
    ...
    [
        InlineKeyboardButton(
                   ...
                   [
                       ...
                       InlineKeyboardButton(text="💠 BOTS LOUNGE", url="t.me/WikiLeaksBots"),
                     ],
                    [                  
                       InlineKeyboardButton(
                             text="💠 PERI GROUP",
                             url=f" https://t.me/+uGCFzxbnn_phYWYx"),
                       InlineKeyboardButton(
                             text="💠 SHOP",
                             url=f"https://t.me/TheWikiLeaksShop"),
                        ],
                       [
                           InlineKeyboardButton(text="💠 GROUP", url="t.me/WikiLeaks69"
       
    ],
]

HELP_STRINGS = """
Hey there, I'm *WikiLeaks Group Bot*!
To make me functional, make sure that i have enough rights in your group.
Helpful commands:
- /start: Starts me! You've probably already used this.
- /help: Sends this message; I'll tell you more about myself!
- /donate: Gives you info on how to support me and my creator.
If you want to report bugs or have any questions on how to use me then feel free to reach out: @TheOnlyMrlucifer.
All commands can be used with the following: [(/),(!),(?),(.),(~)](https://te.legra.ph/file/e6d0760dbb3bde20fd16b.jpg)
...
DONATE_STRING = """Contact to My Pretty [OWNER](t.me/TheOnlyMrLucifer)"""
HELP_IMG= "https://te.legra.ph/file/db05bb1cca3de4ede2270.jpg"
GROUPSTART_IMG= "https://telegra.ph/file/35e730dea457c85cc367b.mp4"

PM_IMG = ( "https://te.legra.ph/file/379ccb294792a6c8bc5c2.jpg",
           "https://te.legra.ph/file/9dab3a16d2ba0965a4024.jpg",
           "https://te.legra.ph/file/0541832d292b54dac3f8f.jpg",
           "https://te.legra.ph/file/1164b4fa2399b63c175f1.jpg",
           "https://te.legra.ph/file/02cd4bad763e34e02ba51.jpg", )
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        reply_markup=InlineKeyboardMarkup(
                [
                  [
                  InlineKeyboardButton(text="💠 OWNER ", url=f"t.me/TheOnlyMrLucifer"),
                  InlineKeyboardButton(text="💠 CHANNEL ", url=f"t.me/WikiLeaksBots"),
                  ]
                ]
            ),
        )
...
def help_button(update, context):
    ...
    try:
        if mod_match:
            ...
            text = (
                "Powered by [Wiki](t.me/TheOnlyMrLucifer) And [Bots](t.me/WikiLeaksBots)\nHere is the help for the *{}* module:\n".format(
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}","[Peri Group](https://te.legra.ph/file/02cd4bad763e34e02ba51.jpg)", parse_mode=ParseMode.MARKDOWN) 
        except Unauthorized:
            LOGGER.warning(
