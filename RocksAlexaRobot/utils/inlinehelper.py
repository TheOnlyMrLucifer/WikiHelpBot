...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("🔐 Wiki Group Bot", url="https://t.me/WikiGroupBot"),
        InlineKeyboardButton("🔄 ɢᴏ ɪɴʟɪɴᴇ", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[WikiLeaks](t.me/TheOnlyMrLucifer):**
**MainBot:** `{bot_state}`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
**Platform:** `{sys.platform}`
**Profiles:** [OWNER](t.me/TheOnlyMrLucifer) | [YOUTUBE](https://www.youtube.com/c/JankariKiDuniya)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Bot's Stats",
            thumb_url="https://te.legra.ph/file/e6d0760dbb3bde20fd16b.jpg",
