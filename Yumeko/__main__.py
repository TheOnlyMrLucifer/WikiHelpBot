...
PM_START_TEXT = """
**Hey I am WikiLeaks Group Bot Anime Version** [ㅤ](https://telegra.ph/file/6643b0fb6792b2e5e844a.mp4)
️➖➖➖➖➖➖➖➖➖➖➖➖➖
...
DONATE_STRING = """Hehe, User!!
 [Is that so!!](https://t.me/TheOnlyMrLucifer ❤️
"""
...
def yumeko_about_callback(update, context):
    ...
    if query.data == "yumeko_":
        ...
        query.message.edit_text(
            text=f"<b> `Cʀᴇᴅɪᴛ Fᴏʀ Yumeko` </b>\n"
            f"\nHᴇʀᴇ Sᴏᴍᴇ Dᴇᴠᴇʟᴏᴘᴇʀs Hᴇʟᴘɪɴɢ Iɴ Mᴀᴋɪɴɢ Tʜᴇ YUMEKO",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="亗 Wiki", url="https://t.me/TheOnlyMrLucifer"),
                    InlineKeyboardButton(text="Wiki Bots • [ᴀc͜͡ɢᴄ]", url="https://t.me/WikiLeaksBots"),
                 ],
                 [
                    InlineKeyboardButton(text="Bot", url="https://t.me/"),
                    InlineKeyboardButton(text="18+ Group", url="https://t.me/"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="yumeko_basichelp"),
        ...
        query.message.edit_text(
            text=f"｢ Setup Guide 」\n"
                 ...
                 f"\nIf you do need help with further instructions feel free to ask in @TheOnlyMrLucifer.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                  [
                     ...
                     InlineKeyboardButton(text="☎️ 18+ Group", url=f"https://t.me/"),
                  ]
                ]
            ),
        )   
